$(function () {
	...
	Page.prototype = {
			...
			bindEvents: function () {
					...
					var upbar_top_height = $('#topBannerWrap').outerHeight(true) + $('#topBarWrap').outerHeight(true) + $(
							'#header').outerHeight(true) + $('#categoryNavWrap').outerHeight(true);
					var upbar_top_height2 = $('#topBarWrap').outerHeight(true) + $('#header').outerHeight(true) + $(
							'#categoryNavWrap').outerHeight(true);
					...
					$('.category>ul>li').hover(function () {
							...
							$(this).children('.li_container').css({
									'display': 'block'
							});
					...
					$('.zuijinliulan').hover(function () {
							$('.zuijin .pi2').css('display', 'none');
							$('.nav div span.zuijin').css({
									'background': ' #fff url(images/redtribg.png) no-repeat 3px 1px',
									'border-top': '1px solid #ccc',
									'margin-top': '-1px'
							});
							$('.nav div span.zuijin a').css({
									'color': '#FF658E'
							});
							$('.nav div .pi3').css({
									'display': 'block'
					...
					$('.topBar_right div').hover(function () {
